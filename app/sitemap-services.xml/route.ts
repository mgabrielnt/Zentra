...
export async function GET() {
  ...
  const urls = [
    { loc: `${BASE}/service`,     hreflang: { en: `${BASE}/service`,    id: `${BASE}/id/service` } },
    { loc: `${BASE}/id/service`,  hreflang: { en: `${BASE}/service`,    id: `${BASE}/id/service` } },
    // optional: expose topical CTA for discovery
    ...services.map((s) => ({ loc: `${BASE}/collaboration?topic=${encodeURIComponent(s.slug)}` })),
  ];
