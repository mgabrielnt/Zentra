        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6">
          ...
          <Reveal delay={0.12}>
            <p className="mt-3 max-w-2xl text-sm md:text-base text-white/70">
              We’ll review your answers and follow up via email or WhatsApp with
              a first proposal, questions, and options for engagement.
            </p>
          </Reveal>

          {/* ❗ FORM CARD TANPA Reveal – selalu tampil di semua device */}
          <div className="mt-6 sm:mt-8 rounded-3xl md:rounded-[32px] border border-white/10 bg-[#050508]/90 p-4 sm:p-6 md:p-8 shadow-[0_0_40px_rgba(0,0,0,0.45)] backdrop-blur-xl">
            {submitted && (
              <div className="mb-6 rounded-2xl border border-emerald-500/40 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-100">
                Thank you! Your collaboration request has been submitted. We’ll
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-7">
              ...
              <div className="space-y-2 text-xs text-white/70">
                <label className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    I prefer to treat this conversation as NDA-covered (we can
                    use our standard NDA or your template).
                  </span>
                </label>
                <label className="flex items-start gap-2">
                  <input
