...
export default function ProjectOverview({ overview }: ProjectOverviewProps) {
  return (
    <section className="relative bg-black">
      <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-16 py-16 sm:py-20 lg:py-32">
      ...
      <div className="hidden md:block pointer-events-none absolute -bottom-32 left-1/2 h-64 w-[80rem] -translate-x-1/2 rounded-full bg-purple-600/3 blur-3xl" />
    </section>
  );
}
