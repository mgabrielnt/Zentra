      ...
      >
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="hidden lg:flex items-center gap-4">
            {/* Spacer Kiri - untuk balance agar navigation di tengah */}
            ...
            {/* Spacer Kanan dengan Language Toggle */}
              ...
              <div className="bg-linear-to-r from-white/5 via-white/10 to-white/5 backdrop-blur-xl rounded-full p-1.5 shadow-2xl border border-white/30 hover:border-white/40 transition-all duration-300">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`
                      relative px-5 py-2.5 rounded-full text-sm font-bold tracking-wide
          ...
          <div className="lg:hidden mt-2 mx-6 bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/20">
              ...
              {navItems.map((item, index) => (
                <li key={index}>
                  <a
                    ...
                    onClick={(e) => handleClick(e, index)}
                    className={`
                      block px-6 py-3 font-bold text-sm transition-all
                      ${activeIndex === index
            ...
            <div className="flex items-center gap-3 px-6 pb-4 pt-2">
              <button
                onClick={() => setLanguage('en')}
                className={`
                  relative flex-1 py-3 rounded-full text-sm font-bold tracking-wide
              ...
              >
                <span className="relative z-10">EN</span>
                {language === 'en' && (
                  <span className="absolute inset-0 bg-linear-to-br from-white/20 to-transparent animate-pulse"></span>
                )}
              </button>
              <button
                onClick={() => setLanguage('id')}
